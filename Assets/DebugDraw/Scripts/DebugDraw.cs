...
public class DebugDraw
{
    public static void DrawSphere(Vector3 position, float size, Color color, Color colorW = default)
    {
        ...
        CommandBufferRendering.renderingEvent.Invoke(DrawUtils.MeshSphere, DrawUtils.GetMatrix(position, size), DrawUtils.GetMaterial(color));
        if (colorW != default)
    ...
    public static void DrawWireSphere(Vector3 position, float size, Color color)
    {
        ...
        for (int i = 0; i < matrix.Length; i++)
        {
            ...
            CommandBufferRendering.renderingEvent.Invoke(DrawUtils.MeshWireCircle, matrix[i], DrawUtils.GetMaterial(color));
        }
    ...
    public static void DrawCube(Vector3 position, Vector3 size, Color color, Color colorW = default)
    {
        ...
        CommandBufferRendering.renderingEvent.Invoke(DrawUtils.MeshCube, DrawUtils.GetMatrix(position, size), DrawUtils.GetMaterial(color));
        if (colorW != default)
    ...
    public static void DrawWireCube(Vector3 position, Vector3 size, Color color)
    {
        ...
        CommandBufferRendering.renderingEvent.Invoke(DrawUtils.MeshWireCube, DrawUtils.GetMatrix(position, size), DrawUtils.GetMaterial(color));
    }
    ...
    public static void DrawCircle(Vector3 position, Vector3 normal, float size, Color color, Color colorW = default)
    {
        ...
        CommandBufferRendering.renderingEvent.Invoke(DrawUtils.MeshCircle, DrawUtils.GetMatrix(position, size, normal), DrawUtils.GetMaterial(color));
        if (colorW != default)
    ...
    {
        CommandBufferRendering.renderingEvent.Invoke(DrawUtils.MeshWireCircle, DrawUtils.GetMatrix(position, size, normal), DrawUtils.GetMaterial(color));
    }
